...
const base64EncodedBinary = readFileSync('../src/tree-sitter-parser/tree-sitter-partiql.wasm', 'base64')
const modifications =
...
writeFileSync('../src/tree-sitter-parser/tree-sitter-parser-inline.ts', encodedPartiQLServer)
