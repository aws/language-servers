...
import { CodeWhispererSigv4ClientConfigurationOptions, createCodeWhispererSigv4Client } from './sigv4/codewhisperer'
import {
    CodeWhispererTokenClientConfigurationOptions,
    createCodeWhispererTokenClient,
    RequestExtras,
} from './token/codewhisperer'
...
import CodeWhispererSigv4Client = require('./sigv4/codewhisperersigv4client')
import CodeWhispererTokenClient = require('./token/codewhispererbearertokenclient')
