...
import { getOrThrowBaseServiceManager } from './amazonQServiceManager/BaseAmazonQServiceManager'
...
export const CodeWhispererServerTokenProxy = CodewhispererServerFactory(getOrThrowBaseServiceManager)

export const CodeWhispererServerIAMProxy = CodewhispererServerFactory(getOrThrowBaseServiceManager)
...
export const QChatServerTokenProxy = QChatServerFactory(getOrThrowBaseServiceManager)
export const QChatServerIAMProxy = QChatServerFactory(getOrThrowBaseServiceManager)
