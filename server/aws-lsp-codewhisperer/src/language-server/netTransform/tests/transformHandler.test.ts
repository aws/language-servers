...
describe('Test Transform handler ', () => {
    let client: StubbedInstance<CodeWhispererServiceBase>
    ...
    beforeEach(async () => {
        ...
        client = stubInterface<CodeWhispererServiceBase>()
        workspace = stubInterface<Workspace>()
        runtime = stubInterface<Runtime>()

        const serviceManager = stubInterface<BaseAmazonQServiceManager>()
        client = stubInterface<CodeWhispererServiceBase>()
