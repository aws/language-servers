...
import { getSupportedLanguageId, supportedSecurityScanLanguages } from '../../utilities/languageDetection'
...
import { SecurityScanEvent } from '../../utilities/telemetry/types'
import { getErrorMessage, parseJson } from '../../utilities/utils'
