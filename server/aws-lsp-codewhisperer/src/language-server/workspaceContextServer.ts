...
export const WorkspaceContextServer =
    ...
    features => {
        const { logging, lsp, workspace, runtime, credentialsProvider, chat, sdkInitializator } = features
        ...
        const awsQRegion = 'us-west-2' //runtime.getConfiguration('AWS_Q_REGION') ?? DEFAULT_AWS_Q_REGION
        const awsQEndpointUrl = 'https://rts.alpha-us-west-2.codewhisperer.ai.aws.dev/' //runtime.getConfiguration('AWS_Q_ENDPOINT_URL') ?? DEFAULT_AWS_Q_ENDPOINT_URL
