...
import { GenerateSuggestionsRequest, GenerateSuggestionsResponse, Suggestion } from '../../shared/codeWhispererService'
...
import { shouldTriggerCompletions, QAutoTrigger, ClassifierAutoTrigger } from './trigger'
