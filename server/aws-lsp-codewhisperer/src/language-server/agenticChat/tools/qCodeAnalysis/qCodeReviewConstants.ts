...
export const Q_CODE_REVIEW_TOOL_DESCRIPTION = [
    ...
    '- Java, Python, JavaScript, TypeScript, JSX, C#, CloudFormation, Terraform, Go, Ruby, C, C++, PHP, Rust, Kotlin, Scala, Shell, SQL',
    '',
    '**Usage Priority:**',
    ...
    'You must not show findings or summary of Q Code Review tool output to user',
