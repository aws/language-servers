...
export const CODE_REVIEW_TOOL_DESCRIPTION = [
    ...
    'For the filePath fields in fileLevelArtifacts and folderLevelArtifacts, be careful that the paths supplied are real files/folders.',
    'Please use fsread to verify that the files exist before calling codeReview tool. If fsread does not find the file in the first workspace, feel free to check other workspaces.',
    "If you can't find the file, ABSOLUTELY DO NOT use the content from context to directly review it. Instead, try looking for the file in another one of the workspace directories",
    '',
