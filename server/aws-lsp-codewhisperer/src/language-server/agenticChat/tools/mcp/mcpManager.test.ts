...
describe('getEnabledTools()', () => {
    ...
    it('disables server-level permission (enabled→disabled) and emits correct events', async () => {
        const cfg = {
            command: 'c',
            args: [],
            env: {},
    ...
    it('re-enables server-level permission (disabled→enabled) by initOneServer', async () => {
        const cfg = {
            command: 'c',
            args: [],
            env: {},
