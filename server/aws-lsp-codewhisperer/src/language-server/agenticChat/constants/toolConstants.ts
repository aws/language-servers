...
export const BUTTON_MODIFY_SHELL_COMMAND = 'modify-shell-command'
export const BUTTON_SAVE_SHELL_COMMAND = 'save-shell-command'
export const BUTTON_CANCEL_SHELL_COMMAND = 'cancel-shell-command'
