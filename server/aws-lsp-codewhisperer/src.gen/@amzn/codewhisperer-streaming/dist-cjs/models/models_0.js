...
exports.GenerateTaskAssistPlanResponseFilterSensitiveLog =
    exports.GenerateTaskAssistPlanRequestFilterSensitiveLog =
    exports.ExportResultArchiveResponseFilterSensitiveLog =
    exports.GenerateAssistantResponseResponseFilterSensitiveLog =
    exports.GenerateAssistantResponseRequestFilterSensitiveLog =
    exports.ResultArchiveStreamFilterSensitiveLog =
    exports.ResultArchiveStream =
    exports.ExportIntent =
    exports.ConversationStateFilterSensitiveLog =
    exports.ContextTruncationScheme =
    exports.ChatTriggerType =
    exports.ChatResponseStreamFilterSensitiveLog =
    exports.ChatResponseStream =
    exports.SupplementaryWebLinksEventFilterSensitiveLog =
    exports.InvalidStateReason =
    exports.FollowupPromptEventFilterSensitiveLog =
    exports.ChatMessageFilterSensitiveLog =
    exports.ChatMessage =
    exports.UserInputMessageFilterSensitiveLog =
    exports.UserInputMessageContextFilterSensitiveLog =
    exports.EditorStateFilterSensitiveLog =
    exports.CursorState =
    exports.DiagnosticFilterSensitiveLog =
    exports.Diagnostic =
    exports.TextDocumentDiagnosticFilterSensitiveLog =
    exports.TextDocumentFilterSensitiveLog =
    exports.SymbolType =
    exports.RuntimeDiagnosticFilterSensitiveLog =
    exports.DiagnosticSeverity =
    exports.BinaryPayloadEventFilterSensitiveLog =
    exports.BinaryMetadataEventFilterSensitiveLog =
    exports.ContentChecksumType =
    exports.ConflictException =
    exports.AssistantResponseMessageFilterSensitiveLog =
    exports.SupplementaryWebLinkFilterSensitiveLog =
    exports.FollowupPromptFilterSensitiveLog =
    exports.UserIntent =
    exports.AssistantResponseEventFilterSensitiveLog =
...
const AssistantResponseMessageFilterSensitiveLog = obj => ({
    ...
    ...(obj.supplementaryWebLinks && {
        supplementaryWebLinks: obj.supplementaryWebLinks.map(item =>
            (0, exports.SupplementaryWebLinkFilterSensitiveLog)(item)
        ),
    }),
...
const DiagnosticFilterSensitiveLog = obj => {
    if (obj.textDocumentDiagnostic !== undefined)
        return {
            textDocumentDiagnostic: (0, exports.TextDocumentDiagnosticFilterSensitiveLog)(obj.textDocumentDiagnostic),
        }
...
const ChatMessageFilterSensitiveLog = obj => {
    ...
    if (obj.assistantResponseMessage !== undefined)
        return {
            assistantResponseMessage: (0, exports.AssistantResponseMessageFilterSensitiveLog)(
                obj.assistantResponseMessage
            ),
        }
    if (obj.$unknown !== undefined) return { [obj.$unknown[0]]: 'UNKNOWN' }
}
...
const ChatResponseStreamFilterSensitiveLog = obj => {
    ...
    if (obj.assistantResponseEvent !== undefined)
        return {
            assistantResponseEvent: (0, exports.AssistantResponseEventFilterSensitiveLog)(obj.assistantResponseEvent),
        }
    ...
    if (obj.supplementaryWebLinksEvent !== undefined)
        return {
            supplementaryWebLinksEvent: (0, exports.SupplementaryWebLinksEventFilterSensitiveLog)(
                obj.supplementaryWebLinksEvent
            ),
        }
...
const ResultArchiveStreamFilterSensitiveLog = obj => {
    if (obj.binaryMetadataEvent !== undefined) return { binaryMetadataEvent: smithy_client_1.SENSITIVE_STRING }
    if (obj.binaryPayloadEvent !== undefined) return { binaryPayloadEvent: smithy_client_1.SENSITIVE_STRING }
...
const GenerateAssistantResponseRequestFilterSensitiveLog = obj => ({
    ...
    ...(obj.conversationState && {
        conversationState: (0, exports.ConversationStateFilterSensitiveLog)(obj.conversationState),
    }),
})
