...
export class ConnectorAdapter {
    ...
    createIdeConnector(mynahUIRef: { mynahUI: MynahUI | undefined }, ideApiPostMessage: (msg: any) => void): any {
    ...
    isSupportedTab(tabId: string): boolean {
        ...
        return this.tabStorage.getTab(tabId)?.type === 'gumby'
    }
    ...
    private getQuickActionHandler() {
        ...
        if (!this.quickActionHandler && mynahUI && connector) {
            this.quickActionHandler = new QuickActionHandler({
                ...
                connector,
                tabsStorage,
                isFeatureDevEnabled: false, // TODO: Settings need to be passed somehow
                isGumbyEnabled: true,
                isScanEnabled: false,
                isTestEnabled: false,
                isDocEnabled: false,
